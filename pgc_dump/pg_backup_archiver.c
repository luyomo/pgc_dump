			 ...
			 DataDumperPtr dumpFn, void *dumpArg)
{
	...
	//printf("ArchiveEntry==========  0  ===================\n");
	AH->tocCount++;
	if (dumpId > AH->maxDumpId)
		AH->maxDumpId = dumpId;
	//printf("ArchiveEntry==========  1   ===================\n");
